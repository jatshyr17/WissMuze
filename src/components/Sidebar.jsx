...
>>>>>>> 8cadbfc7512abb4b162120713c239c745db9db8e
            ...
            <div className='p-4 bg-[#2e3661] m-2 rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4'>
              ...
              <button className='px-4 py-1.5 bg-white text-[15px]  text-black rounded-full mt-4 flex items-center gap-1' onClick={()=>navigate("/playlist")}>
                <img src={assets.playlist_icon} alt="icon" className=' w-5' /><p className='hidden lg:flex '>Create Playlist</p></button>
            </div> 
           </div>
           </div>
          )
